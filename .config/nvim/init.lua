...
require('nvim-treesitter.configs').setup {
  ...
  ensure_installed = { 'tsx', 'c', 'cpp', 'go', 'lua', 'python', 'rust', 'typescript', 'help' },
...
-- Attach vim register to system clipboard
...
vim.keymap.set('n', "<C-a>", ":%y+<Enter>", { noremap = true, silent = true })
...
vim.keymap.set('n', "<A-S-Left>", "<C-W><", { noremap = true, silent = true })
vim.keymap.set('n', "<A-S-Right>", "<C-W>>", { noremap = true, silent = true })
vim.keymap.set('n', "<A-S-Up>", "<C-W>-", { noremap = true, silent = true })
vim.keymap.set('n', "<A-S-Down>", "<C-W>+", { noremap = true, silent = true })

vim.keymap.set('n', '<leader>e', ':NvimTreeToggle<Enter>', { noremap = true, silent = true })

vim.keymap.set('n', 'gl', ":lua vim.diagnostic.open_float()<Enter>", { noremap = true, silent = true })

vim.keymap.set('n', '<leader>b', ":!bash build.sh % xyz<Enter><Enter>", { noremap = true, silent = true })
